...
{
    // NekoBox is sing-box based and needs a rule-capable profile instead of
    // plain share links, otherwise all traffic behavior is determined only by
    // the app's current proxy mode.
    public $flags = ['sing-box', 'hiddify', 'sfm', 'nekobox'];
