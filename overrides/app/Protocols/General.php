...
{
    // Mobile clients that natively import share links are more stable with
    // URI subscriptions than Clash-style YAML profiles.
    public $flags = ['general', 'v2rayn', 'v2rayng', 'passwall', 'ssrplus', 'sagernet', 'v2rc', 'v2ray config manager', 'v2rayconfigmanager'];
